...
このポータルは、クーリングクレジット知識体系全体への入口である。

- [ポータル・ナビゲーションマップ](docs/ja/PORTAL_NAVIGATION_MAP_ja.md)
...
- [Cooling-Credit-Framework](https://github.com/InchaComisho/Cooling-Credit-Framework) — 評価フレームワーク、MRV、スコア、適格性判定。
- [Cooling-Credit-Implementation-Portfolio](https://github.com/InchaComisho/Cooling-Credit-Implementation-Portfolio) — 実装候補領域・プロジェクトポートフォリオ。
- [Cooling-Credit-Implementation-and-Finance-Model](https://github.com/InchaComisho/Cooling-Credit-Implementation-and-Finance-Model) — 支払主体、資金循環、維持管理、ガバナンス、制度設計。

```text
ポータル → 定義 → 評価フレームワーク → 実装ポートフォリオ → 資金・ガバナンス
```
...
このポータルは、検索されやすい言葉をクーリングクレジット体系へ接続する。
...
目的は、サステナビリティを理念や政策用語で終わらせず、実測可能な冷却成果、水循環回復、土壌再生、森林回復、海洋循環支援、自然冷却機能回復へ接続することである。
...
<p align="center">
  <img src="images/cooling_credit_incentive_structure_ja.png" alt="クーリングクレジットのインセンティブ構造" width="100%">
</p>
...
このポータルでは、それらを **実測可能な物理的冷却と自然冷却機能回復** へ接続する。
