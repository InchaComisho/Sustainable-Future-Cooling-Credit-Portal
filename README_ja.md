...
梅雨・真夏・乾燥高温地域・高湿度熱帯都市の4気候シナリオにおいて、ミスト冷却・除湿型WBGT低減・雨水貯留＋腐葉土化＋土壌保水の3モデルを比較した事前検証シミュレーション。

各モデルと気候条件の組み合わせにおける複合クーリングスコアを定量化し、高湿度・季節変動環境でのクーリングクレジット評価の基盤を提供する。
